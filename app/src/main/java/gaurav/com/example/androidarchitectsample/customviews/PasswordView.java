 ...
 *
 * Last Modified 9/11/16 7:20 PM
 */

package gaurav.com.example.androidarchitectsample.customviews;
...
public class PasswordView extends AppCompatEditText {
    ...
    */
    ...
    private int eyeTint = getResources().getColor(R.color.colorPrimary);
